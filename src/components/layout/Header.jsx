...
import { truncateText } from '../../helper/textTruncate';
    ...
    return (
        <div className='h-dvh relative'>
            ...
            <div className='absolute z-20 top-1/2 left-16 max-w-2xl -translate-y-1/2 w-full pe-6 text-white'>
               ...
               <p className='text-xl'>{truncateText(data?.overview, 100)}</p>
                ...
                <button onClick={playTrailer} className='py-2 px-6 mt-6 inline-block rounded-full ms-3 bg-slate-800 text-white'>Play</button>
            </div>
